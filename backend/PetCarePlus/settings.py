...
CSRF_TRUSTED_ORIGINS = get_env('CSRF_TRUSTED_ORIGINS', default='https://impressed-billi-backenddev-e631e481.koyeb.app,https://petcarepp.vercel.app,https://petcarepp.netlify.app', cast=lambda v: [s.strip() for s in v.split(',')])
