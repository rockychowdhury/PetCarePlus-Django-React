"""
Populate Service Provider Database with 15 realistic accounts
Run with: python populate_service_providers.py
"""
...
def create_business_hours(provider):
...
def main():
    print("Starting service provider population...")
    ...
    for cat_name, slug in [
        ...
        cat, _ = ServiceCategory.objects.update_or_create(
            slug=slug,
            defaults={"name": cat_name, "description": f"{cat_name} services for pets"}
        )
        categories[slug] = cat
    ...
    for i, provider_data in enumerate(PROVIDERS, 1):
        ...
        print(f"  {'Created' if created else 'Updated'} provider: {provider.business_name}")
        
        # Create business hours
        if not provider.hours.exists():
            create_business_hours(provider)
            print(f"  Created business hours")
        ...
        print(f"  Added {len(IMAGES)} media files")
        ...
        if provider_data['type'] == 'foster':
            ...
            print(f"  Created foster service details")
            ...
            print(f"  Created veterinary clinic details")
            ...
            print(f"  Created trainer service details")
            ...
            print(f"  Created groomer service details")
            ...
            print(f"  Created pet sitter service details")
    
    print("\n" + "="*50)
    print("Database population completed successfully!")
    print(f"Created/Updated {len(PROVIDERS)} service providers")
    print("="*50)
